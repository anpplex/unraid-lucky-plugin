...
printf '%s\n' "$VERSION" > "$BUILD_DIR/usr/local/emhttp/plugins/lucky/VERSION"
printf '%s\n' "$PLUGIN_VERSION" > "$BUILD_DIR/usr/local/emhttp/plugins/lucky/PLUGIN_VERSION"
printf '%s\n' "$UPSTREAM_SHA256" > "$BUILD_DIR/usr/local/emhttp/plugins/lucky/UPSTREAM_SHA256"
...
chmod 0755 "$BUILD_DIR/usr/local/emhttp/plugins/lucky/scripts/lucky-upstream-update"
...
- Add separate GitHub plugin and Lucky upstream update controls with live logs.
  </CHANGES>
